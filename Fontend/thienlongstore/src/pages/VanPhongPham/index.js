...
function VanPhongPham(props) {
    const listProduct = props.productsRedux.filter((p) => p.catId === 2);
...
export default connect(mapStateToProps, mapDispatchToProps)(VanPhongPham);
